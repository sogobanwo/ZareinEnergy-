              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div className="flex justify-center items-center">
                  <div className="flex justify-start items-center gap-2">
                    <img src="/zarein-logo.png" alt="Zarein Energy" className="h-6 sm:h-7 md:h-8 w-auto" />
                  </div>
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[748.71px] lg:w-[748.71px] text-center flex justify-center flex-col text-[#1a5f7a] text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-normal leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 font-serif px-2 sm:px-4 md:px-0">
                    Powering the Future
                    <br />
                    with Zarein Energy
                  </div>
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(26,95,122,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                  ...
                  <div className="self-stretch flex-1 flex justify-start items-start">
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="relative w-full h-full overflow-hidden">
                        {/* Product Image 1 - Grid Solutions */}
                        <div
                        ...
                        >
                          <img
                            src="/grid-solutions-dashboard.jpg"
                            alt="Smart Grid Management System - Real-time Power Distribution"
                            className="w-full h-full object-cover"
                          />
                        </div>

                        {/* Product Image 2 - Renewable Energy */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                        ...
                        >
                          <img
                            src="/renewable-energy-dashboard.jpg"
                            alt="Renewable Energy Monitoring Dashboard"
                            className="w-full h-full object-cover"
                          />
                        </div>

                        {/* Product Image 3 - Energy Storage */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                        ...
                        >
                          <img
                            src="/energy-storage-dashboard.jpg"
                            alt="Energy Storage Management System"
