      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-[#1a5f7a] text-sm font-medium leading-5 font-sans">
              Solutions
            </div>
            <div className="flex flex-col justify-end items-start gap-2">
              <div className="text-[#1a5f7a] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#0f4a61] transition-colors">
                Renewable Energy
              </div>
              <div className="text-[#1a5f7a] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#0f4a61] transition-colors">
                Grid Solutions
          ...
          {/* Company Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[#1a5f7a] text-sm font-medium leading-5 font-sans">Company</div>
          ...
          {/* Resources Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[#1a5f7a] text-sm font-medium leading-5 font-sans">Resources</div>
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-[#1a5f7a] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#0f4a61] transition-colors">
                Terms of use
              </div>
              <div className="self-stretch text-[#1a5f7a] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#0f4a61] transition-colors">
                White Papers
